...
export default function LeftMenu({ activeMenu, setActiveMenu, menuLabels }: { activeMenu: string, setActiveMenu: (label: string) => void, menuLabels: string[] }) {
  return (
    <aside
      className="min-w-[240px] bg-gradient-to-br from-white/80 to-light-card/90 dark:from-dark-card/80 dark:to-[#181926]/90 rounded-3xl p-6 flex flex-col gap-3 shadow-2xl card-glow backdrop-blur-md bg-opacity-95 h-fit mr-10 ml-[-180px] border border-light-border dark:border-dark-border sticky top-[100px] z-30 text-light-fg dark:text-dark-fg transition-all duration-300 animate-fadein"
