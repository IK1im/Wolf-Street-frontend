...
const Card: React.FC<CardProps> = ({ title, accent, children, actions, className }) => (
  <div
    className={clsx(
      'flex flex-col rounded-xl border-2 px-8 py-7 bg-light-card dark:bg-dark-card transition-colors duration-200',
